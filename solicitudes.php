    ...
    <div class="container position-relative z-1">
        <div class="row align-items-center">
            <div class="col-lg-6 text-center text-lg-start">
                <h1 class="display-4 fw-bold mb-3">Solicitudes Pendientes<span
                        ...
                        <!-- Solicitudes -->
                          <table style="width:100%; border:2px">
                            ...
                            <?php 
                            $items = mysqli_query($conn,"SELECT * FROM tv_solicitudes WHERE Status = 0");
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <?php echo $row['Creditos'];?>
                                        </td>
                                       
                                        <td align="center">
                                            <?php echo $row['Adultos'];?>
                                        </td>
                                        <td align="center">
                                            <?php echo $row['Fecha'];?>
                                        </td>
                                        <td align="center">
                                            <a href="./v_validarSolicitud.php?usuario=<?php echo $row['Usuario'];?>&id=<?php echo $row['Id'];?>">Validar</a>


                                        </td>
                                        <td align="center">
                                            <a href="./v_eliminarSolicitud.php?id=<?php echo $row['Id'];?>">Eliminar</a>
                                        </td>
