    ...
    <div class="container position-relative z-1">
        <div class="row align-items-center">
            <div class="col-lg-6 text-center text-lg-start">
                <h1 class="display-4 fw-bold mb-3">Registrar Cliente<span
                        style="color: #F7710E;"></span></h1>

                        <form action="./v_registrarUsuario.php" method="POST" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="apellidop" name="apellidop" maxlength="100" required>
            </div>

            <div class="col-md-6">
                <label for="apellidom" class="form-label">Apellido Materno</label>
                <input type="text" class="form-control" id="apellidom" name="apellidom" maxlength="100">
            </div>
            ...
            <div class="col-md-6">
                <label for="suscripciontermina" class="form-label">Duración de suscripción</label>
                <select class="form-select" id="suscripciontermina" name="suscripciontermina" required>
            ...
            <div class="col-md-6">
                <label for="18" class="form-label">+18</label>
                <select class="form-select" id="18" name="18" required>
